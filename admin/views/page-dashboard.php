		...
		<tr>
			<td style="width:8%;">
				<div style="display:flex;align-items:center;gap:4px;">
					<?php if($st==='pass'):?><i data-lucide="circle-check" style="width:14px;height:14px;color:#16a34a;"></i>
					<?php elseif($st==='warn'):?><i data-lucide="triangle-alert" style="width:14px;height:14px;color:#ca8a04;"></i>
					<?php else:?><i data-lucide="circle-x" style="width:14px;height:14px;color:#dc2626;"></i><?php endif;?>
