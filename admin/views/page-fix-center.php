...
<div class="gf-card<?php echo $geo_forge_is_p1 ? ' gf-card-highlight' : ''; ?>"<?php echo $geo_forge_is_p1 ? ' style="border-color:#16a34a;border-left:3px solid #16a34a;"' : ''; ?>>
	...
	<tr data-fix-id="<?php echo esc_attr( $geo_forge_fx2['id'] ); ?>">
		<td><strong style="font-size:13px;"><?php echo esc_html( $geo_forge_fx2['label'] ); ?></strong><br><span class="gf-muted"><?php echo esc_html( $geo_forge_fx2['description'] ); ?></span><?php if ( ! empty( $geo_forge_fx2['audit'] ) ) : ?><br><span class="geo-forge-fix-audit-line" style="font-size:11px;color:<?php echo ! empty( $geo_forge_fx2['audit']['pass'] ) ? '#16a34a' : '#dc2626'; ?>;"><?php echo esc_html( ( ! empty( $geo_forge_fx2['audit']['pass'] ) ? '✅ ' : '❌ ' ) . $geo_forge_fx2['audit']['message'] . ' (' . $geo_forge_fx2['audit']['checked_at'] . ')' ); ?></span><?php endif; ?><?php if ( ! empty( $geo_forge_fx2['note'] ) ) : ?><br><span class="geo-forge-fix-note" style="font-size:11px;color:#ca8a04;"><?php echo esc_html( $geo_forge_fx2['note'] ); ?></span><?php endif; ?></td>
