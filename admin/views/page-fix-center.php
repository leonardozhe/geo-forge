...
<div class="geo-forge-wrap">
	<div class="geo-forge-header">
		<h1>
			...
			<span class="geo-forge-subtitle"><?php esc_html_e( 'Fix Center', 'geo-forge' ); ?></span>
		</h1>
		...
		<?php foreach ( $grouped as $group_label => $items ) : ?>
			<div class="geo-forge-card">
				<h3>
					...
					<span class="geo-forge-badge geo-forge-badge-info"><?php echo esc_html( (string) count( $items ) ); ?></span>
				</h3>
				<table class="pure-table pure-table-horizontal pure-table-striped geo-forge-fix-table">
					<thead>
						<tr>
							<th><?php esc_html_e( 'Fix', 'geo-forge' ); ?></th>
							<th><?php esc_html_e( 'Risk', 'geo-forge' ); ?></th>
							<th><?php esc_html_e( 'Status', 'geo-forge' ); ?></th>
							<th><?php esc_html_e( 'Applied', 'geo-forge' ); ?></th>
					...
					<tbody>
						...
						?>
							<tr data-fix-id="<?php echo $fix_id; ?>">
								...
								<td>
									<button type="button" class="pure-button pure-button-primary geo-forge-fix-apply" data-fix="<?php echo $fix_id; ?>" <?php disabled( $is_applied ); ?>>
										<?php $is_applied ? esc_html_e( 'Re-apply', 'geo-forge' ) : esc_html_e( 'Apply', 'geo-forge' ); ?>
									</button>
									<button type="button" class="pure-button geo-forge-fix-verify" data-fix="<?php echo $fix_id; ?>" <?php disabled( ! $is_applied ); ?>>
										<?php esc_html_e( 'Verify', 'geo-forge' ); ?>
									</button>
									<button type="button" class="pure-button geo-forge-fix-rollback" data-fix="<?php echo $fix_id; ?>" <?php disabled( ! $is_applied ); ?>>
