...
<div class="gf-card<?php echo $is_p1?' gf-card-highlight':'';?>"<?php echo $is_p1?' style="border-color:#16a34a;border-left:3px solid #16a34a;"':'';?>>
	...
	<tr data-fix-id="<?php echo $id;?>">
		...
		<td><span style="color:<?php echo esc_attr($rc($fx2['risk_level']));?>;font-weight:600;font-size:12px;"><?php echo esc_html(ucfirst($fx2['risk_level']));?></span></td>
		<td class="geo-forge-fix-status-cell"><?php echo esc_html($si($fx2['status']).' '.ucfirst($fx2['status']));?></td>
		<td class="gf-muted"><?php echo esc_html($fx2['applied_at']??'—');?></td>
